...
- 2026-09-03 | REVIEW clean | диф — ровно 2 хука (сохранение/восстановление скролла), без
  побочных изменений; удалённый файл содержал вперемешку правки других задач — закоммичена
  только относящаяся к TASK-038 часть через частичный патч
- 2026-09-03 | COMPLETE | коммит 8672284, тестовые данные (throwaway тренер id=700, слоты,
  бронь) удалены после верификации
