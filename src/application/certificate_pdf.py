...
def build_certificate_pdf(
    *,
    ...
    Branding: ``Settings.certificate_pdf_brand_*``.
    """
    cfg = Settings()
    brand = (cfg.certificate_pdf_brand_display_name or "ICE STUDIO").strip()
    tagline = (cfg.certificate_pdf_brand_tagline_ru or "").strip()
