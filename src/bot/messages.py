...
TRAINER_START_WELCOME = (
    "👋 Привет!\n\n"
    "Ты в боте как тренер. Нажми <b>«Обзор»</b> слева от поля ввода — там все разделы в мини-приложении.\n\n"
...
TRAINER_AFTER_LINK_STEP_PENDING = (
    ...
    "в «Обзор» откроются все разделы. Статус смотри в профиле в приложении."
)
...
TRAINER_GATE_CALLBACK_BLOCKED = (
    "Этот раздел пока закрыт. Сначала заполни анкету и дождись одобрения — открой «Профиль» в «Обзор»."
)
TRAINER_GATE_BLOCKED_PROFILE = (
    "Расписание, заявки и записи закрыты: в анкете не хватает обязательных полей.\n\n"
    "Открой «Обзор» → «Профиль» в мини-приложении — там видно, что добить."
)
TRAINER_GATE_BOOKING_READY = (
    ...
    "Открой <b>«Обзор»</b> слева от поля ввода."
)
...
TRAINER_GATE_INVITE_SUBMIT = (
    "Анкета заполнена, но заявка на проверку ещё не отправлена. Открой «Обзор» → «Профиль» и в мини-приложении "
