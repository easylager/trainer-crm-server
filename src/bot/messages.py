...
TRAINER_LINK_SUCCESS = (
    ...
    "Статус и анкета — в разделе «Профиль» в меню. Помощь: /guide"
)
...
TRAINER_AFTER_LINK_STEP_BLOCKED = (
    ...
    "👉 Нажми <b>«Профиль»</b> ниже — там видно, чего не хватает."
)
TRAINER_AFTER_LINK_STEP_INVITE_SUBMIT = (
    "<b>Сейчас</b>: анкета почти готова — открой «Профиль» в меню и сохрани анкету в мини-приложении: "
    "заявка на проверку уйдёт автоматически. Обычно ответ в течение рабочего дня."
)
