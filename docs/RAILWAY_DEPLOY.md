...
**После первого деплоя из GitHub запускается только API (сервер).** Клиентский, тренерский и админский боты нужно добавить вручную — три отдельных сервиса с своими командами запуска (раздел 2).
