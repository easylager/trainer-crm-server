...
| What | Where |
|---|---|
| **This entrypoint** | `docs/epics/ice-discovery/agent-start.md` ← you are here |
| Git + when a TASK is finished | `docs/epics/ice-discovery/agent-git.md` |
| Parallel agents / lanes | `docs/epics/ice-discovery/agent-lanes.md` |
| Your job (AC / scope) | `.ai/tasks/TASK-NNN.md` |
| Visual UI SoT | `design/prototypes/2026-09-arenas-client-app.html` |
| Product / data designs | `design/arenas-client-app.md`, `design/ingestion-parsers-v1.md` |
| Initiative map | `docs/epics/ice-discovery/epic.md` |

**Load order (mandatory):**

1. This file  
2. `docs/epics/ice-discovery/agent-git.md`  
3. If several agents: `docs/epics/ice-discovery/agent-lanes.md` (your lane only)  
...
```text
Ice Discovery initiative. Entrypoint: read docs/epics/ice-discovery/agent-start.md then docs/epics/ice-discovery/agent-git.md.
...
- Lane (if named): SCHEMA | PLACE | INGEST | API | UI | SPEC — see docs/epics/ice-discovery/agent-lanes.md
